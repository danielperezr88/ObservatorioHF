...
class BucketedMemorize(object):
    ...
    def __init__(self, func):
        ...
        self.blob = storage.blob.Blob(self.cache_filename,bucket)
    ...
    def bucket_cache(self):
        """
        Updates cache file from cache bucket.
        """
        self.save_cache()
        self.blob.upload_from_filename(self.cache_filename)
